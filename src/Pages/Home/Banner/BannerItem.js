...
const BannerItem = ({slide}) => {
    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full">
                ...
                <div className="absolute text-white flex justify-end transform -translate-y-1/2 left-24 top-1/4">
                ...
                <div className="absolute text-white flex justify-end transform -translate-y-1/2 left-24 top-1/2 w-2/5">
                ...
                <div className="absolute text-white flex justify-end transform -translate-y-1/2 left-24 top-3/4 ">
